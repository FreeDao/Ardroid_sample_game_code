...
public class PlanMoveThread extends Thread{
	...
	public boolean KEY_UP = false;//向上键是否被按下
	public boolean KEY_DOWN = false;//向下键是否被按下
	public boolean KEY_LEFT = false;//向左的键被按下
	public boolean KEY_RIGHT = false;//向右的键被按下
	public boolean KEY_A = false;//A的键被按下
	public boolean KEY_B = false;//B的键被按下
	GameView gameView = null;
	public PlanMoveThread(PlaneActivity activity,GameView gameView){//构造器
