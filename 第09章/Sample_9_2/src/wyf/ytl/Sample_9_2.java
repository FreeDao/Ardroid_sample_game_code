...
abstract class State {  //所有状态类型的基类
	public Sample_9_2 activity;
	public State(Sample_9_2 activity){//构造器
		this.activity = activity;
	}
	public abstract State toNextState(MasterAction ma);	
}
class HappyState extends State{ //表示高兴状态的类
	public HappyState(Sample_9_2 activity) {//构造器
		super(activity);
	}
...
class CommonState extends State{ //表示普通状态的类
	public CommonState(Sample_9_2 activity) {//构造器
		super(activity);
	}
	public State toNextState(MasterAction ma){//去下一状态
		State result=this;		
...
class AwayState extends State {//表示出走状态的类
	public AwayState(Sample_9_2 activity) {//构造器
		super(activity);
	}
	public State toNextState(MasterAction ma){//去下一状态
		State result=this;		
